...
VIDEOS_DIR = os.path.join('.', 'videos')  # Adjust the directory if necessary
video_path = os.path.join(VIDEOS_DIR, '/home/mona/Traffic detection/videos/vidd3.mp4')  # Replace with your video filename
...
while ret:
    ...
    for result in results.boxes.data.tolist():
        ...
        if score > threshold:
            ...
            cv2.putText(frame, english_class_name, (int(x1), int(y1 - 10)),
